		...
		<div class="container">
			...
			<div class="head row">
				...
				<div style="z-index:1"class="col-sm-6 col-md-6 col-xl-6 col-lg-6">
					<form>
         				<button class="tambahBut" style="float:left" type="submit" formaction="supplier_tambah.php">Tambah Supplier</button>
					  </form>	
					  <form>
         				<button class="tambahBut" style="float:left"type="submit" onclick="window.open('supplier_cetak.php')">Cetak</button>
      				</form>	
				</div>
